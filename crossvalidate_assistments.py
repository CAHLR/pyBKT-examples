...
data_multiguess = data_helper.convert_data("as.csv", skill_name, df=df, multiguess=True)
...
data_multiprior = data_helper.convert_data("as.csv", skill_name, df=df, multiprior=True)
